                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ol class="list-group list-group-numbered">
                            <li><strong>Step 1:</strong> Log in to the DEVICE using your web credentials.</li>
                            <li><strong>Step 2:</strong> Enter your <code>MAC Address</code> and <code>API Key</code> into the device, and wait for the response !</li>
                            <li><strong>Step 3:</strong> Check your email and refresh this page for the device authentication message.</li>
                            <li><strong>Step 4:</strong> Authorize your device through the vFCL web platform by clicking the <strong>Auth</strong> button.</li>
