                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-6">
                            <div class="card text-center">
                                <h5 class="card-header">New Device Activation</h5>
                                <div class="card-body">
                                    <p class="card-text">Please follow the steps to activate your new device.</p>
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#modalToggle">Activate New Device</button>
                                </div>
                            </div>
                        </div>
                    </div>
